# -*- coding: utf-8 -*-
"""
Created on Thu Feb  4 20:59:22 2016
...
--> using throat.porelengths in conductivity calculation

For Percolation class of algorithm
...
#    cases = ['wetting', 'imbibition']
#    occupancies = ['occupancy_wetting', 'occupancy_imbibition']
    occupancy = 'occupancy_'+case
#    occupancy = occupancies[0]#+'_trapping'
#    print('Case: ', cases[0])
    for Pc_step_wp in Pc_wp:
        alg_wp.return_results(Pc=Pc_step_wp,
                              cases=[case],
                              occupancies=[occupancy],
                              trapping=trapping)
        if trapping:
            occupancy += '_trapping'
        p_occ_wp = water['pore.'+occupancy]
        t_occ_wp = water['throat.'+occupancy]
...
#            Tinvaded1 = water['throat.'+occupancies[0]]
