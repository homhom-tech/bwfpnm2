...
def vanderwaals(phase,
                pore_P='prop.pressure',
                pore_T='prop.temperature',
                pore_Pc='prop.critical_pressure',
                pore_Tc='prop.critical_temperature',
                **kwargs):
    r"""
